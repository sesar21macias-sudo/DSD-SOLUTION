...
export declare function getTableInfo(req: Request, res: Response): Promise<void>;
export declare function getPublicTables(req: Request, res: Response): Promise<void>;
